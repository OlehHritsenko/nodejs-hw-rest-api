...
const sender = "olehhritsenko@gmail.com";
...
const verification = async (email, code) => {
  ...
  const msg = {
    ...
    html: `<strong>Let's verify your email address so you can complete your registration:</strong><br/><a href=${link} target="_blank">Confirm</a>`,
  };
  try {
